...
func main() {
	var (
		...
		outMutationFile = flag.String("out-mutation", filepath.Clean("../backend/tests/generated_openapi_mutation_contract_test.go"), "path to generated mutation contract test file")
		outReadFile     = flag.String("out-read", filepath.Clean("../backend/tests/generated_openapi_read_contract_test.go"), "path to generated read contract test file")
	)
	flag.Parse()
	...
	mutationOut := renderGeneratedMutationTest(mutationCases)
	if err := os.WriteFile(*outMutationFile, mutationOut, 0o644); err != nil {
		log.Fatalf("write generated mutation test: %v", err)
	}

	readOut := renderGeneratedReadTest(readCases)
	if err := os.WriteFile(*outReadFile, readOut, 0o644); err != nil {
		log.Fatalf("write generated read test: %v", err)
	}
}
...
func renderGeneratedMutationTest(mutationCases []generatedCase) []byte {
	var b bytes.Buffer
	renderSharedPreamble(&b)
	...
	b.WriteString(mutationTestFunctionsSource)
	return b.Bytes()
}

func renderGeneratedReadTest(readCases []generatedCase) []byte {
	var b bytes.Buffer
	...
	b.WriteString(readTestFunctionSource)
	return b.Bytes()
}

func renderSharedPreamble(b *bytes.Buffer) {
	b.WriteString("// Code generated by openapi-contract-test-gen; DO NOT EDIT.\n")
	b.WriteString("\n")
	b.WriteString("package tests\n")
	b.WriteString("\n")
...
const mutationTestFunctionsSource = `
