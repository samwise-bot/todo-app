...
- [x] Mainline execution completed on highest-priority Next task #51; moved `Next -> In Progress -> Done` assigned to `samwise`.
- [x] Added measurable TODO App performance SLA baseline + CI regression gate criteria to roadmap/architecture docs.
