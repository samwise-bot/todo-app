...
describe('createAppStoreSnapshot', () => {
  test('indexes entities and sorts Next tasks by priority then dueAt then id', () => {
    const snapshot = createAppStoreSnapshot({
      tasks: [
        { id: 12, state: 'next', priority: 3, dueAt: '2026-03-07T10:00:00Z' },
        { id: 8, state: 'next', priority: 2, dueAt: '2026-03-09T10:00:00Z' },
        { id: 5, state: 'next', priority: 2, dueAt: '2026-03-05T10:00:00Z' },
        { id: 9, state: 'in_progress', priority: 1 },
        { id: 3, state: 'next', priority: 2, dueAt: '2026-03-05T10:00:00Z' }
      ],
      boards: [{ id: 1 }],
      columns: [{ id: 2 }],
      principals: [{ id: 7 }]
